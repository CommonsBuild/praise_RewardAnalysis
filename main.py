...
PRAISE_DATA_PATH = "mockDatasets/2021_12_01-104611-praise.csv"
SOURCECRED_DATA_PATH = "mockDatasets/2021_12_01-104611-sourcecred.csv"
...
def calc_praise_rewards(praiseData, tokensToDistribute):
    ...
    slimData = praiseData[['TO', 'FINAL QUANT']].groupby(
        ['TO']).agg('sum').reset_index()
...
print(rewardboard_addresses)

praise_distribution = calc_praise_rewards(
    praise_data, NUMBER_OF_TOKENS_TO_DISTRIBUTE)
